...
- Refatoração 2:   
  ...
  - Critério 2:  Ok 
  - Critério 3:  Ok 
    Por que não agrupar mais atributos na nova classe? Desse modo vocês saíram
de um mal-cheiro (obsessão primitiva) e caíram em outro mal-cheiro (classe
preguiçosa). 
  
- Refatoração 3:   
  - Critério 1:  Ok 
  - Critério 2:  NOk - Os métodos-objetos extraídos continuam implementados
    utilizando variáveis temporárias. -60 pontos. 
  - Critério 3:  Ok 
